...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.6875, 179.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.6875, 179.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.6875, 200.0, 77.0, 47.0 ],
					"style" : "",
					"text" : "is playing in ambisonic system"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.6875, 206.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 59.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "player ID to monitor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 348.0, 57.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 682.0, 139.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 488.6875, 255.0, 265.0, 11.0 ],
					"size" : 360.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.5, 331.416748, 99.0, 20.0 ],
					"style" : "",
					"text" : "touch on screen",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 264.0, 124.0, 22.0 ],
					"style" : "",
					"text" : "expr 100. - $f1 * 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 297.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "pack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 178.0, 206.5, 76.0, 22.0 ],
					"style" : "",
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 233.5, 89.0, 22.0 ],
					"style" : "",
					"text" : "expr $f1 * 100."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.0, 324.0, 168.0, 288.0 ],
					"rightvalue" : 100,
					"style" : "",
					"topvalue" : 100
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 497.0, 161.0, 93.0, 22.0 ],
									"style" : "",
									"text" : "numspeakers 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 502.0, 191.0, 86.0, 22.0 ],
									"style" : "",
									"text" : "numsources 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 366.0, 122.0, 73.0, 22.0 ],
									"style" : "",
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 366.0, 256.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 366.0, 152.0, 70.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 366.0, 180.5, 60.0, 22.0 ],
									"style" : "",
									"text" : "layout $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 186.0, 152.0, 53.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 186.0, 182.0, 177.0, 22.0 ],
									"style" : "",
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 375.5, 204.25, 375.5, 204.25 ],
									"source" : [ "obj-158", 0 ]
								}
...
,
					"patching_rect" : [ 287.6875, 293.0, 72.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 368.6875, 324.0, 520.0, 288.0 ],
					"radius" : [ 1.0 ],
					"radiusconstraint" : [ 0 ],
					"rightclicklock" : [ 0 ],
					...
					"sourceseditable" : [ 1 ],
					"sourceslevels" : [ -60.0 ],
					"sourcespositions" : [ -0.074115, 0.665567, 0.742649 ],
					"speakerseditable" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 368.6875, 259.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "* -1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 428.6875, 259.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.6875, 293.0, 144.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 488.6875, 228.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.6875, 228.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 368.6875, 228.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 368.6875, 197.0, 89.0, 22.0 ],
					"style" : "",
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 557.0, 139.0, 59.0, 20.0 ],
					"style" : "",
					"text" : "soundID"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 610.0, 139.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 172.0, 71.0, 20.0 ],
					"style" : "",
					"text" : "orientation"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 134.5, 59.0, 20.0 ],
					"style" : "",
					"text" : "touch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.5, 53.0, 202.0, 22.0 ],
					"style" : "",
					"text" : "enterExit 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.1875, 83.0, 206.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 34.0, 81.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "route 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 637.0, 170.0, 136.0, 22.0 ],
					"style" : "",
					"text" : "experienceOver 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 170.0, 89.0, 22.0 ],
					"style" : "",
					"text" : "15.353117"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 466.0, 140.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 394.0, 140.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 322.0, 140.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 154.0, 89.0, 35.0 ],
					"style" : "",
					"text" : "0.36875 0.830435"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 193.0, 89.0, 49.0 ],
					"style" : "",
					"text" : "6.354042 47.957584 351.567657"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 34.0, 140.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 11,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 34.0, 110.5, 739.0, 22.0 ],
					"style" : "",
					"text" : "route enterExit deviceOrientation deviceTouch deviceTouchIsOn swipeDown swipeUp deviceShake deviceAcc soundId experimentOver"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 384.916748, 75.0, 22.0 ],
					"style" : "",
					"text" : "s playerMsg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 469.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "s toServer"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 123.5, 404.0, 95.0, 22.0 ],
									"style" : "",
									"text" : "/updateRequest"
								}
...
,
					"patching_rect" : [ 13.0, 414.916748, 118.0, 49.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 13.0, 357.5, 105.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 331.416748, 77.0, 22.0 ],
					"style" : "",
					"text" : "r fromServer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.25, 630.5, 39.0, 20.0 ],
					"style" : "",
					"text" : "clock"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.25, 630.5, 82.0, 20.0 ],
					"style" : "",
					"text" : "server status"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 68.25, 584.5, 40.0, 40.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.25, 530.5, 85.0, 22.0 ],
					"style" : "",
					"text" : "r serverStatus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.25, 557.5, 95.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.75, 595.5, 31.0, 20.0 ],
					"style" : "",
					"text" : "3 s",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 2
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 19.25, 557.5, 42.0, 22.0 ],
					"style" : "",
					"text" : "* 10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 19.25, 530.5, 41.0, 22.0 ],
					"style" : "",
					"text" : "% 10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.25, 503.5, 45.0, 22.0 ],
					"style" : "",
					"text" : "r clock"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.25, 584.5, 40.0, 40.0 ],
					"size" : 99.0,
					"style" : ""
				}
...
,
					"patching_rect" : [ 13.0, 289.75, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 262.75, 72.5, 20.0 ],
					"style" : "",
					"text" : "debug print"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 13.0, 262.75, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.25, 10.0, 231.75, 24.0 ],
					"style" : "",
					"text" : "Dummy OSC receive / send"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-43::obj-157" : [ "live.dial[38]", "xoffset", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "thru.maxpat",
